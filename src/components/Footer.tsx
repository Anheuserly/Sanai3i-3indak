        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10 mb-12">
          ...
          <div className="space-y-3">
            ...
            <div className="flex flex-col gap-2.5 text-xs font-semibold text-slate-400">
              ...
              <Link href="/download" className="text-accent hover:underline flex items-center gap-1 font-bold">
              ...
              <Link href="/#leaderboard" className="hover:text-white transition-colors">قائمة شرف الصنائعية</Link>
              <Link href="/#tracking" className="hover:text-white transition-colors">تتبع حالة الطلبات</Link>
              <Link href="/faq" className="hover:text-accent transition-colors flex items-center gap-1">
                <span>الأسئلة الشائعة والدعم</span>
                <span className="text-[10px] bg-accent/20 text-accent px-1.5 py-0.5 rounded font-bold">جديد</span>
              </Link>
            </div>
          </div>
          ...
          {/* Legal & Policies */}
          <div className="space-y-3">
            <h4 className="text-sm font-black text-white border-r-2 border-emerald-500 pr-2">
              السياسات والشروط
            </h4>
            <div className="flex flex-col gap-2.5 text-xs font-semibold text-slate-400">
              <Link href="/terms" className="hover:text-white transition-colors">شروط وأحكام الاستخدام</Link>
              <Link href="/privacy" className="hover:text-white transition-colors">سياسة الخصوصية وحماية البيانات</Link>
              <Link href="/disclaimer" className="hover:text-white transition-colors">إخلاء المسؤولية والدفع النقدي</Link>
              <Link href="/charter" className="hover:text-white transition-colors">ميثاق شرف الحرفيين والمعايير</Link>
            </div>
          </div>
